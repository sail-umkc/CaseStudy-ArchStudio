...
public class XadlSelectorDialog{
	...
	public static ObjRef showSelectorDialog(Shell parentShell, String text, 
	XArchFlatInterface xarch, IResources resources, 
	ObjRef rootRef, int showFlags, int selectionFlags){
	...
	public static ObjRef[] showSelectorDialog(Shell parentShell, String text, 
	XArchFlatInterface xarch, IResources resources, 
	ObjRef rootRef, int showFlags, int selectionFlags, final boolean allowMultipleSelections){
		...
		bOK.setText("OK");
 		...
 		final Listener okListener = new Listener(){
	        ...
	        messageBox.setMessage("Please select one " +
	         (allowMultipleSelections ? "or more " : "") + 
