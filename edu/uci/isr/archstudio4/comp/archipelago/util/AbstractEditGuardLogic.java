...
public abstract class AbstractEditGuardLogic extends AbstractThingLogic implements IBNAMenuListener, IBNAModelListener, IBNAMouseListener{
									...
									if((newValue == null) || (newValue.length() == 0)){
										...
										try{
											...
											Display.getDefault().syncExec(new Runnable(){
												public void run(){
													Composite c = AS.editor.getParentComposite();
													if(c != null){
