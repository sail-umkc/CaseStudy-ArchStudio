...
public class ArchipelagoEditor extends AbstractArchstudioEditor{
	...
	public ArchipelagoEditor(){
		...
		setBannerInfo(((ArchipelagoMyxComponent)comp).getIcon(), 
	...
	protected AbstractArchstudioOutlinePage createOutlinePage(){
		return new ArchipelagoOutlinePage(this, xarch, getXArchRef(), resources, fileman, prefs, graphLayout, bni, guardTracker, selector);
	}
