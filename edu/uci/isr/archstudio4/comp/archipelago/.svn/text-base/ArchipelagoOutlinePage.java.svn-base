...
public class ArchipelagoOutlinePage extends AbstractArchstudioOutlinePage implements IFileManagerListener{
	...
	public ArchipelagoOutlinePage(ArchipelagoEditor editor, XArchFlatInterface xarch, ObjRef xArchRef, IResources resources, IFileManager fileman, IPreferenceStore prefs, IGraphLayout graphLayout, IBooleanNotation bni, IGuardTracker guardTracker, ISelector selector){
		...
		AS = new ArchipelagoServices(eventBus, new DefaultArchipelagoEditorPane(editor), data, xarch, resources, fileman, prefs, graphLayout, bni, guardTracker, selector);
