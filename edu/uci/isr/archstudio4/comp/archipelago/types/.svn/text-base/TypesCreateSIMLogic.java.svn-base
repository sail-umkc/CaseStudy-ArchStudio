				...
				if((t instanceof IHasWorld) && (outerSignatureRef != null)){
					...
					if(brickTypeRef != null){
						...
						if(brickTypeID != null){
							...
							if((brickAssemblyRootThing != null) && (brickAssemblyRootThing instanceof IHasAssemblyData)){
								BoxAssembly brickAssembly = BoxAssembly.attach(view.getWorld().getBNAModel(), (IHasAssemblyData)brickAssemblyRootThing);
