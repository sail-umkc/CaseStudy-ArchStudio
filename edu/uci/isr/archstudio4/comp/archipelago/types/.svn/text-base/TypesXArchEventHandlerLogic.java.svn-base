...
public class TypesXArchEventHandlerLogic extends AbstractThingLogic implements IXArchEventHandlerLogic{
	protected ArchipelagoServices AS = null;
	protected ObjRef xArchRef = null;
	protected TypedThingSetTrackingLogic<IHasWorld> ttstlView = null;

	public TypesXArchEventHandlerLogic(ArchipelagoServices AS, ObjRef xArchRef, TypedThingSetTrackingLogic<IHasWorld> ttstlView){
		this.AS = AS;
