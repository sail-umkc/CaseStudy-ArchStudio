...
public class StatechartsFileManagerListener implements IFileManagerListener{
	protected ArchipelagoServices AS = null;
	protected ObjRef xArchRef = null;
	
	public StatechartsFileManagerListener(ArchipelagoServices services, ObjRef xArchRef){
		this.AS = services;
	...
	public void fileSaving(final ObjRef xArchRef, final IProgressMonitor monitor){
		if(xArchRef.equals(this.xArchRef)){
			...
			StatechartsEditorSupport.writeHints(AS, xArchRef, monitor);
		}
	}
}
